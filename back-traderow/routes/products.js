...
router.get('/', async (req, res) => {
    ...
    try {
        ...
        if(!productList){
            return res.status(500).json({ success: false, message: 'The product was not found...👎'});
        } else {
...
router.delete('/:id', async (req, res) => {
    try {
        ...
        if(!product){
            return res.status(400).json({ success: false, message: 'The product cannot be deleted...👎'});
        } else {
...
router.get('/get/featured/:count', async (req, res) => {
    try {
        const count = parseFloat(req.params.count) ? parseFloat(req.params.count) : 0;
